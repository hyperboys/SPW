<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageMainAdmin.Master" AutoEventWireup="true"
    CodeBehind="SurveyOrder.aspx.cs" Inherits="SPW.UI.Web.Page.SurveyOrder" %>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <asp:GridView ID="gridProductDetail" runat="server" ForeColor="#507CD1" AutoGenerateColumns="False"
                    ...
                    <AlternatingRowStyle BackColor="White" />
                    <Columns>
                        <asp:BoundField DataField="PRODUCT.PRODUCT_CODE" HeaderText="รหัสสินค้า" ItemStyle-Width="25%" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle Width="25%"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="PRODUCT.PRODUCT_NAME" HeaderText="ชื่อสินค้า" ItemStyle-Width="25%" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle Width="25%"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="PRODUCT_QTY" HeaderText="จำนวน" ItemStyle-Width="25%" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle Width="25%"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="IS_FREE" HeaderText="ชนิด" ItemStyle-Width="25%" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle Width="25%"></ItemStyle>
                        </asp:BoundField>
                    </Columns>
                    <EditRowStyle BackColor="#2461BF" />
