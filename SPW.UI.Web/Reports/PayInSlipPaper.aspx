<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageReport.Master"
    AutoEventWireup="true" CodeBehind="PayInSlipPaper.aspx.cs" Inherits="SPW.UI.Web.Reports.PayInSlipPaper" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="page-header">PayIn Paper</h1>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="PayInSlipPaperReport.rpt">
        </Report>
