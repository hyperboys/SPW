...
{
    public partial class ManageOrderHQPreview : System.Web.UI.Page
    {
        ...
        private void InitialData()
        {
            ...
            HyperLink2.Attributes["href"] = "ManageOrderHQEdit.aspx?ORDER_ID=" + Request.QueryString["ORDER_ID"] + "&STORE_CODE=" + Request.QueryString["STORE_CODE"] + "&STORE_NAME=" + Request.QueryString["STORE_NAME"];
            BindGridview();
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("ManageOrderHQSuccess.aspx?ORDER_ID=" + ORDER_ID + "&STORE_CODE=" + STORE_CODE + "&STORE_NAME=" + STORE_NAME);
        }
        #endregion
    }
}