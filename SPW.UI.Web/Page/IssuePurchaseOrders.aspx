<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MasterPageMainAdmin.Master" CodeBehind="IssuePurchaseOrders.aspx.cs" Inherits="SPW.UI.Web.Page.IssuePurchaseOrders" %>
        ...
        <div class="panel panel-primary">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <!-- /.row (nested) -->                    
                    <div class="panel panel-primary">
                        <asp:GridView ID="gdvPO" runat="server" ForeColor="#507CD1" AutoGenerateColumns="False" 
                            DataKeyNames="RAW_ID" PageSize="20" Width="100%" EmptyDataText="ไม่พบข้อมูล" OnRowEditing="gdvPO_RowEditing"
                    ...
                    <div class="form">
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <asp:Button ID="btnApprove" class="btn btn-primary" runat="server" Text="อนุมัติ" Height="30px" Width="70px" OnClick="btnApprove_Click"/>  
