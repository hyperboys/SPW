...
{
    public partial class SearchEmpResultAssessment : System.Web.UI.Page
    {
        ...
        {
            Response.RedirectPermanent("ResultEmpAssessment.aspx?id=" + gridEmployee.DataKeys[e.NewEditIndex].Values[0].ToString());
        }
