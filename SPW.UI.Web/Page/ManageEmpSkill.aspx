<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageMainAdmin.Master"
    AutoEventWireup="true" CodeBehind="ManageEmpSkill.aspx.cs" Inherits="SPW.UI.Web.Page.ManageEmpSkill" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="page-header">
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Page/SearchEmpSkill.aspx">ทักษะพนักงาน</asp:HyperLink>
        -
        <asp:Label ID="lblName" runat="server" Text="เพิ่มทักษะพนักงานใหม่"></asp:Label></h1>
                    ...
                    <div class="form">
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <asp:TextBox ID="txtPosition" class="form-control" runat="server" Height="35px" placeholder="ชื่อทักษะ"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="กรุณากรอกชื่อทักษะ"
                                ...
                                <div class="col-md-3">
                                    <asp:Button ID="btnCancel" runat="server" class="btn btn-primary" Text="ยกเลิก" PostBackUrl="~/Page/SearchEmpSkill.aspx" />
                                </div>
                            </div>
                        </div>
                    </div>
