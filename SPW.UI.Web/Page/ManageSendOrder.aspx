<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageMainAdmin.Master"
    AutoEventWireup="true" CodeBehind="ManageSendOrder.aspx.cs" Inherits="SPW.UI.Web.Page.ManageSendOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="page-header">จัดการใบขึ้นของ</h1>
</asp:Content>
                        ...
                        <asp:GridView ID="gdvManageOrderHQ" runat="server" ForeColor="#507CD1" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="ยกเลิก">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbtnDelete" runat="server" Visible='<%#Eval("ISDELETE")%>' OnClientClick="return confirm();" AlternateText="Yes" CommandName="DelDeliveryOrder" CommandArgument="<%#((GridViewRow)Container).RowIndex%>">
