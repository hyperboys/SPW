...
namespace SPW.UI.Web.Page
{
    public partial class SearchGrade : System.Web.UI.Page
    {
        ...
        public List<EMP_GRADE_SET> DataSouce
        {
            get
            {
                if (ViewState["EMP_GRADE_SET"] == null)
                {
                    ViewState["EMP_GRADE_SET"] = new List<EMP_GRADE_SET>();
                }
                var list = (List<EMP_GRADE_SET>)ViewState["EMP_GRADE_SET"];
                return list;
            }
            set
            {
                ViewState["EMP_GRADE_SET"] = value;
            }
        }
