<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPageMainAdmin.Master" AutoEventWireup="true" CodeBehind="ManageOrderHQDetail.aspx.cs" Inherits="SPW.UI.Web.Page.ManageOrderHQDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="page-header">
        ...
        <asp:Label ID="lblName" runat="server" Text="รายละเอียด"></asp:Label></h1>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <!-- /.row (nested) -->
            <div class="panel panel-primary">
                <asp:GridView ID="gdvManageOrderHQDetail" runat="server" ForeColor="#507CD1" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="PRODUCT_NAME" HeaderText="ชื่อสินค้า" ItemStyle-Width="30%" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle Width="30%"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="COLOR_TYPE_NAME" HeaderText="ลวดลาย" ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle Width="20%"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="COLOR_NAME" HeaderText="สี" ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle Width="20%"></ItemStyle>
                        </asp:BoundField>
                        ...
                        <asp:BoundField DataField="FLEE" HeaderText="ฟรี" ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle Width="10%"></ItemStyle>
                        </asp:BoundField>
                    </Columns>
