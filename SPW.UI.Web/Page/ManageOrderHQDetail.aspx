                    ...
                    <div class="panel panel-primary">
                        <asp:GridView ID="gdvManageOrderHQDetail" runat="server" ForeColor="#507CD1" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="PRODUCT_QTY" HeaderText="จำนวน" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center">
                                    <ItemStyle Width="10%"></ItemStyle>
                                </asp:BoundField>
                                <asp:BoundField DataField="PRODUCT_PRICE_TOTAL" HeaderText="ราคารวม" ItemStyle-Width="17%" ItemStyle-HorizontalAlign="Center">
                                    <ItemStyle Width="17%"></ItemStyle>
                                </asp:BoundField>
                                <asp:BoundField DataField="FLEE" HeaderText="ฟรี" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center">
                                    <ItemStyle Width="10%"></ItemStyle>
                                </asp:BoundField>
                            </Columns>
