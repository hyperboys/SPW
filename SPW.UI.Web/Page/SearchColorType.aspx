            ...
            <div class="panel panel-primary">
                <asp:GridView ID="gridTracery" runat="server" ForeColor="#507CD1" AutoGenerateColumns="False"
                    ...
                    OnRowEditing="gridTracery_EditCommand" OnPageIndexChanging="gridTracery_PageIndexChanging"
                     OnRowDeleting="gridTracery_RowDeleting" OnRowDataBound="gridTracery_RowDataBound"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="COLOR_TYPE_SUBNAME" HeaderText="ชื่อย่อลวดลายสินค้า" ItemStyle-Width="40%" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle Width="40%"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="COLOR_TYPE_NAME" HeaderText="ชื่อลวดลายสินค้า" ItemStyle-Width="40%" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle Width="40%"></ItemStyle>
                        </asp:BoundField>
