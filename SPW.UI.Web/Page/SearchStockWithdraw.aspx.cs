...
{
    public partial class SearchStockWithdraw : System.Web.UI.Page
    {
        ...
        protected void gridWR_EditCommand(object sender, System.Web.UI.WebControls.GridViewEditEventArgs e)
        {
            ...
            Response.RedirectPermanent("StockWithdrawApprove.aspx?WR_BK_NO=" + gridWR.DataKeys[e.NewEditIndex].Values[0].ToString() + "&WR_RN_NO=" + prRnNo);
        }
