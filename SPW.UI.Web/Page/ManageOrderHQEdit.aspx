                ...
                <asp:GridView ID="gdvManageOrderHQDetail" runat="server" ForeColor="#507CD1" AutoGenerateColumns="False" OnRowDeleting="gdvManageOrderHQDetail_RowDeleting"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="PRODUCT_NAME" HeaderText="ชื่อสินค้า" ItemStyle-Width="30%" ItemStyle-HorizontalAlign="Center">
                         ...
                         <asp:TemplateField HeaderText="ลวดลาย" ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                         ...
                         <asp:TemplateField HeaderText="สี" ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                        ...
                        <asp:BoundField DataField="PRODUCT_WEIGHT" HeaderText="น้ำหนัก" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center">
                         ...
                         <asp:TemplateField HeaderText="ราคาต่อหน่วย" ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                        ...
                        <ItemTemplate>
                         ...
                         <asp:TemplateField HeaderText="ราคารวม" ItemStyle-Width="30%" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                        ...
                        <ItemTemplate>
                            <asp:TextBox ID="txtFleeQty" runat="server" style="width:35px;height:35px;" Text='<%# Eval("FLEE") %>' OnChange="check_change_flee(this)"></asp:TextBox>
