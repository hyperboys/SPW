...
{
    public partial class StockRawSetting : System.Web.UI.Page
    {
        ...
        private void InitialData()
        {
            ...
            {
                List<STOCK_RAW_SETTING> lstSTOCK_RAW_SETTING = cmdStockRawSettingService.GetAll(int.Parse(Request.QueryString["RAW_ID"].ToString()));
                List<DATAGRID> listDataGrid = new List<DATAGRID>();
                DATAGRID _datagrid = new DATAGRID();

                if (lstSTOCK_RAW_SETTING != null)
                {
                    lstSTOCK_RAW_SETTING.ForEach(e =>
                    {
                        ...
                        _datagrid.STOCK_QTY = e.STOCK_QTY;
