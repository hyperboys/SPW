<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageMainAdmin.Master" AutoEventWireup="true"
    CodeBehind="SendOrderStore5.aspx.cs" Inherits="SPW.UI.Web.Page.SendOrderStore5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="alert alert-success" id="alert" style="height:50px">                                    
        <b><div class='glyphicon glyphicon-ok' ></div><asp:Label ID="lblName" runat="server" Text="  สร้างใบขึ้นของสำเร็จ"></asp:Label></b>
    </div>
</asp:Content>
                ...
                <asp:GridView ID="grideInOrder" runat="server" ForeColor="#507CD1" AutoGenerateColumns="False"
                    ...
                    <Columns>
                      <asp:BoundField DataField="PRODUCT.PRODUCT_NAME" HeaderText="ชื่อสินค้า" ItemStyle-Width="30%" ItemStyle-HorizontalAlign="Center">
                        ...
                        <asp:BoundField DataField="PRODUCT_SEND_REMAIN" HeaderText="จำนวน" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center">
                        ...
                        <asp:BoundField DataField="PRODUCT_WEIGHT_TOTAL" HeaderText="น้ำหนักรวม" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Center">
