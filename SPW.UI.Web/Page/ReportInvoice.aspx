<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MasterPageMainAdmin.Master" CodeBehind="ReportInvoice.aspx.cs" Inherits="SPW.UI.Web.Page.ReportInvoice" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="page-header">พิมพ์รายการส่งซ่อม</h1>
</asp:Content>
        ...
        <div class="panel-body">
                        ...
                        <div class="form-group">
                            <table style="width: 630px">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">&nbsp;</td>
                                    <td>
                                        <asp:Button ID="Button1" class="btn btn-primary" runat="server" Text="ค้นหา" OnClick="btnSearch_Click" />
                                    </td>
                                    <td style="text-align: center">&nbsp;</td>
                                    <td>
                                        <asp:Button ID="Button2" class="btn btn-primary" Text="รีเซท" runat="server" OnClick="btnReset_Click" />
                                    </td>
                                    <td style="text-align: center">&nbsp;</td>
                                    <td>
                                        <asp:Button ID="btnPrint" class="btn btn-primary" Text="พิมพ์" runat="server" OnClick="btnPrint_Click" />
                                    </td>
                                </tr>
                            </table>
                        </div>
            ...
            <div class="panel panel-primary">
                ...
                <asp:GridView ID="gdvInv" runat="server" ForeColor="#507CD1" AutoGenerateColumns="False"
                    ...
                    OnPageIndexChanging="gdvInv_PageIndexChanging"
