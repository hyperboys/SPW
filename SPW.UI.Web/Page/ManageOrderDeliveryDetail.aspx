            ...
            <div class="panel panel-primary">
                <asp:GridView ID="gdvManageOrderHQ" runat="server" ForeColor="#507CD1" AutoGenerateColumns="False"
                    ...
                    <Columns>            
                        ...
                        <asp:BoundField DataField="STORE.STORE_CODE" HeaderText="รหัสร้าน"></asp:BoundField>
                        <asp:BoundField DataField="STORE.STORE_NAME" HeaderText="ชื่อร้าน"></asp:BoundField>
                        <asp:BoundField DataField="DELORDER_PRICE_TOTAL" HeaderText="ราคา"></asp:BoundField>
                        <asp:BoundField DataField="DELORDER_WEIGHT_TOTAL" HeaderText="น้ำหนัก"></asp:BoundField>
